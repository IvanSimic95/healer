            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="header-box" id="order">
                        <h1 style="margin-top: 10px;">When and Where <br> You'll Meet Your Future Husband</h1>
                    ...
                    <div style="margin-top: 15px;margin-bottom:15px;" class="row">
                        <div class="col-lg-6">
                            <div class="text-container">
                                ...
                                <br>
                                <p>By tapping into a blend of profound psychic insight, astrological alignment, and spiritual intuition, I seek the vibrational patterns that signal the emergence of your future husband into your life. My skills, honed over years of spiritual practice and psychic artistry, allow me to discern the intricate details - the where, the how, and the when of this monumental encounter.</p>
                                <br>
