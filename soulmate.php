                ...
                <img style="border-radius:4px;max-width: 350px;" src="https://soulmatehealer.com/images/yey.jpg">				
                    <form id="ajax-form" class="form-order" name="order_form" action="javascript:void(0)" method="post">
                        ...
                        <div class="form-floating form-floating-icon mb-2">
                            <input style="border: 1px solid #333;" class="form-control" id="fullname" oninvalid="setCustomValidity('Plz enter on Alphabets ')" type="text" title="Please enter Full Name without numbers or symbols!" pattern="[a-zA-Z][a-zA-Z\s]*" name="form_name" placeholder="First & Last Name" required="">
