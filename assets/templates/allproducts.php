            ...
            <div style="margin-top: 15px;margin-bottom:15px;" class="row">
                ...
                <div class="col-md-4 col-6 m-auto">				
                    <div style="margin-bottom:5px;border:0px;background-color:#e7d7f5;" class="card">
					   ...
					   <div class="card-image">
                            <img class="img-fluid" src="/images/products/energy.png" alt="alternative">
                        </div>
                    </div>
				...
				<div class="col-md-4 col-6 m-auto">				
					...
					<button onclick="location.href='/future-baby'" style="border-radius: 0px 0px 5px 5px;margin-bottom:20px;" class="form-control-submit-button">READ MORE</button>
                </div>
                ...
                <div class="col-md-4 col-6 m-auto">				
                    <div style="margin-bottom:5px;border:0px;background-color:#e7d7f5;" class="card">
					   ...
					   <div class="card-image">
                            <img class="img-fluid" src="/images/products/pastlife.png" alt="alternative">
                        </div>
                    </div>
					<button onclick="location.href='/readings'" style="border-radius: 0px 0px 5px 5px;margin-bottom:20px;" class="form-control-submit-button">READ MORE</button>
                </div>
                <div class="col-md-4 col-6 m-auto">				
                    <div style="margin-bottom:5px;border:0px;background-color:#e7d7f5;" class="card">
					   ...
					   <div class="card-image">
                            <img class="img-fluid" src="/images/products/husband.png" alt="alternative">
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-6 m-auto">				
                    <div style="margin-bottom:5px;border:0px;background-color:#e7d7f5;" class="card">
					   ...
					   <div class="card-image">
                            <img class="img-fluid" src="/images/products/ask.png" alt="alternative">
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-6 m-auto">				
                    <div style="margin-bottom:5px;border:0px;background-color:#e7d7f5;" class="card">
					   ...
					   <div class="card-image">
                            <img class="img-fluid" src="/images/products/thoughts.png" alt="alternative">
                        </div>
                    </div>
					<button onclick="location.href='/inner-thoughts'" style="border-radius: 0px 0px 5px 5px;margin-bottom:20px;" class="form-control-submit-button">READ MORE</button>
                </div>
