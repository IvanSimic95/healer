        ...
        <div style="border:2px solid orange; border-radius:0.5rem;background-color: rgba(242, 236, 231, 0.9);">
          ...
          while($row = $result->fetch_assoc()) {
            ...
            if($row["order_status"]=="shipped"){$status="completed";}else{$status = $row["order_status"];}
              ...
              ';
              ?>
              <div class="chat_box" style="width: 420px; margin: 0px; height: 650px; position:fixed;bottom:0;right:0;z-index:999;max-width:100%">
                <i class="fas fa-times"></i>
                <div class="chat_loader" id="talkjs-container-<?php echo $orderID; ?>" style="width: 420px; margin: 0px; height: 650px;max-width:100%">
                    <i>Loading chat...</i>
                </div>
              </div>
