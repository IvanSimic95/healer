<div class="sides " style="display: flex;flex-wrap: nowrap;flex-direction: row;align-items: stretch;">
     
       <!-- <label for="form_day">Day*</label>-->
    
        <select class="day" id="form_day" name="form_day" required="">
       ...
       <!-- <label for="form_month">Month*</label>-->
        <select class="month" name="form_month" required="">
        ...
        <select class="form_year year" name="form_year" required="">
