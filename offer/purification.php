        ...
        <div class="container" style="max-width:1100px;">
            ...
            <div style="margin-top:0px;">
                ...
                <div class="p-4" style="border:2px solid orange; border-radius:0.5rem;background-color: white;">
                    ...
                    <h1 style="margin:0;padding-top:25px;padding-bottom:10px;">WAIT! LAST OFFER!</h1>
                    <div class="progress">
                    ...
                    <h1 style="margin:0;padding-top:25px;padding-bottom:10px;">Would you like to receive our Psychic Purification?</h1>
                    <h6>You can get it only this time with 50% discount!</h6>

                    <img class="img-fluid" src="/images/products/purification.png" style="width:450px;"><br>
                    

                    <div style="padding:25px;"><p style="font-size: 23px;">Add Purification to your order for $149.00</p>  </div> 
