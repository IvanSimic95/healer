            ...
            <div style="margin-top:0px;">
                ...
                <div class="p-4" style="border:2px solid orange; border-radius:0.5rem;background-color: white;">
                    <div class="row m-0 p-0 progress-pc" style="border:1px solid;border-color: rgba(47, 47, 47, 0.168627);border-radius:0.33rem;">
                        <div class="col-12 col-sm-12 col-md-4" style="padding:10px; font-weight:bold;">STEP 1: ORDER PAID</div>
                    ...
                    <h4 style="margin:0;padding-top:25px;padding-bottom:10px;">THIS IS AN EXCLUSIVE SERVICE WHICH I'M ONLY OFFERING A FEW TIMES A YEAR!</h4>
                    ...
                    <h1 style="margin:0;padding-top:25px;padding-bottom:10px;">PERSONAL PSYCHIC READING</h1>
                   

                    <img class="img-fluid" src="/images/products/personal.png" style="width:450px;"><br>

                    <div class="text textcenter"><p style="font-size: 23px;font-weight:bold;">WOULDN'T BE GREAT TO JUST KNOW THE TRUTH INSTEAD OF CONSUMMING YOURSELF WITH CONSTANT THOUGHTS?</p>  </div> 
                    
                    <div class="text"><p style="font-size:22px;max-width:none;">Your personal psychic reading will help answer some important questions that you've been asking yourself for a long time.</p></div>
                    
                    <div class="text"><p style="font-size:22px;max-width:none;"> If you would like to know more about your future love life, career, health, or where your life is headed in general, this is the perfect service for you.</p></div>
                    
                    <div class="text"><p style="font-size:22px;max-width:none;">You will receive your reading within 24 hours with everything you need to find out about yourself.</p></div>
                    <div class="text textcenter"><p style="font-size:22px;max-width:none;">Add to your order for only <b>$20 right now!</b> (usually $60)</p></div>
