...
<br/>
  ...
  <div class="col-lg-12">
				...
				<br>
                        <a style="width:100%;text-align:center;" class="btn-solid-reg" href="/soulmate-drawing">ORDER NOW</a>
                    </div> <br clear="all">
                </div>  
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12 m-auto">
                    <div style="margin-bottom:20px;border:0px;background-color:#fff;" class="card">
					   <div class="card-image">
                        ...
                        <div class="card-body">
                            <h4 class="card-title-prod">Jasmine</h4>
                       </div>
					   <div style="color:#1a9e42;font-weight:500;font-size: 11px;margin-top: -10px;"><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span><span class="fa fa-star checked"></span> <i style="margin-left: 15px;" class="fas fa-check-square"></i> Verified</div>
