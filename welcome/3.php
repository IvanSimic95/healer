...
<head>
    ...
    <link href="/css/welcome/normalize.css" rel="stylesheet" type="text/css">
    <link href="/css/welcome/components.css" rel="stylesheet" type="text/css">
    <link href="/css/welcome/spellvixen.css" rel="stylesheet" type="text/css">
    <link href="/css/welcome/style.css" rel="stylesheet" type="text/css">
    <link href="/css/welcome/welcome2.css" rel="stylesheet" type="text/css">
    <script src="https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js" type="text/javascript"></script>
    <script type="text/javascript">
        WebFont.load({
            google: {
                families: ["Lato:100,100italic,300,300italic,400,400italic,700,700italic,900,900italic", "Open Sans:300,300italic,400,400italic,600,600italic,700,700italic,800,800italic", "Droid Sans:400,700"]
            }
        });
    </script>
        ...
        <?php if ($v == 1) { ?>
            ...
            <div class="main-body-section wf-section" style="background-color:transparent;">
                <div class="container w-container">
                    ...
                    <p class="sub-paragraph notcenter">Greetings from the "Soulmate Healer". In a world where true connection feels like a rarity, I offer a beacon of hope. My unique gift doesn't just anticipate the future; it paints a vivid image of your heart's deepest yearning—a love that promises warmth, understanding, and unwavering commitment.</p>
                    ...
                    <p class="sub-paragraph notcenter"><b>SPECIAL REVEAL:</b> The Moment of Serendipity</p>
                    <p class="sub-paragraph notcenter">Your soulmate is more than just a partner; he's the missing puzzle piece, fitting seamlessly into the recesses of your heart. When you meet, it will feel like coming home. The universe has a destined moment for this magical meeting, and I'll provide a glimpse into when this heart-fluttering encounter will happen.</p>
                    ...
                    <p class="sub-paragraph notcenter"><b>YOUR PRIVACY, OUR PRIORITY:</b> Exclusively Digital, Unquestionably Confidential</p>
