...
<link href="https://fonts.googleapis.com/css2?family=Cabin:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
    ...
    <link href="/welcome/images/favicon.png" rel="shortcut icon" type="image/x-icon">
    <link href="/welcome/images/webclip.png" rel="apple-touch-icon">
    ...
    <body class="body">
        ...
        <div class="body-container w-container">
            ...
            <div class="header-section">
                <h1 class="headline"><span class="bolded-headline">PSYCHIC PORTRAIT OF YOUR SOULMATE</span></h1>
                <div class="video w-embed w-script">
                    ...
                    <form id="ajax-form" class="form-order" name="order_form" action="javascript:void(0)" method="post" data-rewardful>
                        ...
                        <script>
                            ...
                            $("#helper-delivery-express").click(function() {
                                ...
                                jQuery('.new_prce').animate({
                                    ...
                                    jQuery('.new_prce').html('$59').animate({
                                        'opacity': 1
                                    }, 200);
                                });
                            ...
                            $("#helper-delivery-fast").click(function() {
                                ...
                                jQuery('.new_prce').animate({
                                    ...
                                    jQuery('.new_prce').html('$39').animate({
                                        'opacity': 1
                                    }, 200);
                                });
                            ...
                            $("#helper-delivery-standard").click(function() {
                                ...
                                jQuery('.new_prce').animate({
                                    ...
                                    jQuery('.new_prce').html('$29').animate({
                                        'opacity': 1
                                    }, 200);
                                });
                        ...
                        <div class="d-flex flex-row flex-wrap align-items-center position-relative fs-4 price-total">
                            <span style="color:#ec1e3b !important;font-weight:400" class="badge me-0 new_prce">$ <b>29</b><sup style="font-size: 19px;">99</sup></span>
        ...
        <?php if ($v == 1) { ?>
            ...
            <div class="main-body-section wf-section">
                <div class="container w-container">
                    ...
                    <p style="background-color:#2e2e3d;color:#fff !important;text-align:center;padding:15px 0px;border-radius:0.5rem;font-size:20px !important;" class="sub-paragraph pcenter"><strong>YOUR DESTINY ILLUSTRATED</strong></p>
                    <p class="sub-paragraph notcenter">👋 Greetings from the "<b>Soulmate Healer</b>". In a world where true connection feels like a rarity, I offer a beacon of hope. My unique gift doesn't just anticipate the future; it paints a vivid image of your heart's deepest yearning 💜 a love that promises warmth, understanding, and unwavering commitment.</p>
                    <p class="sub-paragraph notcenter">Many women, just like you, find themselves at life's crossroads - yearning for genuine love, a partner to share dreams with, someone to erase past hurts and promise a future filled with passion. This isn’t a mere illustration. It's a door to a future 🔮 filled with shared laughter, endless conversations, and moments where you feel seen and cherished.</p>
                    <p class="sub-paragraph notcenter">Simply entrust 👼 me with your name and date of birth, and I'll embark on a journey, delving into the universe's grand design. Within this vast expanse, I find your soul's counterpart the one person who will hold your hand through life's highs and lows, who will listen, truly listen, to every whispered hope and silent tear. As I sketch 🖌️ every line captures a story, every shade encapsulates a promise, and every detail whispers of a love that’s waiting to be found.</p>
                    ...
                    <p style="background-color:#2e2e3d;color:#fff !important;text-align:center;padding:15px 0px;border-radius:0.5rem;" class="sub-paragraph notcenter"><strong>SPECIAL REVEAL:</strong><br/>The Moment of Serendipity</p>
                    <p class="sub-paragraph notcenter"><u>Your soulmate</u> is more than just a partner; he's the missing puzzle piece, fitting seamlessly into the recesses of your heart. When you meet ❤️ it will feel like coming home. The universe has a destined moment for this magical meeting, and I'll provide a glimpse into when this heart - fluttering encounter will happen.</p>
                    <p class="sub-paragraph notcenter">🌠 Over the years, from silver screens to ordinary streets, countless women have sought the revelations I provide. It's a universal quest, this search for true love, and every woman, no matter her journey, deserves her fairy - tale ending. ✨ By choosing this path, you're not just seeking a face. You're seeking a future, and I am honored to guide you towards it.</p>
                    <p style="background-color:#2e2e3d;color:#fff !important;text-align:center;padding:15px 0px;border-radius:0.5rem;" class="sub-paragraph notcenter"><strong>YOUR PRIVACY, OUR PRIORITY:</strong><br/>Exclusively Digital, Unquestionably Confidential</p>
                    <p class="sub-paragraph notcenter">All revelations will be sent directly to your chosen email 💌 ensuring your personal details remain private. With round-the-clock access from your user portal, know that your journey towards love is both safe and sacred.</p>
                </div>
            </div>
      ...
      <div class="button-wrapper">
        <a data-w-id="9ca0b638-11a4-0aa1-331f-7ef8023444e2" href="#" style="font-weight:400" class="order-now-button w-button">ORDER NOW<br><span class="btn-sub-text">And Watch Your Life Magically Change</span>&zwj;</a>
